...
public class ServletTabla extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		salida.println("<!DOCTYPE html>\r\n"
				...
				+ "            <input type=\"text\" class=\"form-control\" id=\"nombre1\" placeholder=\"Introduce tu nombre\" />\r\n"
				+ "          </div>\r\n"
				...
				+ "            <input type=\"text\" class=\"form-control\" id=\"nombre2\" placeholder=\"Introduce tu nombre\" />\r\n"
				+ "          </div>\r\n"
				+ "          <div class=\"form-group\">\r\n"
				...
				for (int i = 0; i < dao.getList().size(); i++) {
					salida.println("    <tr>\r\n"
							...
							+ "      <td>"+dao.getList().get(i).getFecha()+"</td>\r\n"
